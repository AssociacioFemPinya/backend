...
return [
    ...
    "step_select_all_row_explanation" => "Click one or several cells, assign a position, the cord number -if it is part of the core, it is not necessary- and to which row it belongs.",
    ...
    "step_style_map_explanation" => "Click on several cells and then choose the styles you want to apply. You can make different combinations or leave it as it is.",
    "borders" => "Borders",
